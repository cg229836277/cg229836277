...
hljs.LANGUAGES.perl = function() {
    ...
    {
        b: "(" + hljs.RSR + "|split|return|print|reverse|grep)\\s*",
        k: {
            split: 1,
            "return": 1,
            print: 1,
...
hljs.LANGUAGES.php = {
    ...
    dM: {
        ...
        hljs.CNM, hljs.BNM, hljs.inherit(hljs.ASM, {
            i: null
